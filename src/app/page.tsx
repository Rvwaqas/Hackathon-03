...
export default function Home() {
  return (
  <>
  <div className="w-[100%] mix-h-screen" >
<Navbar />
<Hero/>
<Range/>
<Product/>

<div className=" w-[100%] h-[550px] md:h-[780px] mt-[3100px] md:mt-[300px] ">
  <h1 className="text-[#616161] text-center font-semibold text-[20px] leading-[30px]">Share your setup with</h1>
   <h1 className="text-center font-bold text-[35px] md:text-[40px] leading-[48px] text-[#3A3A3A]">#FuniroFurniture</h1> 
